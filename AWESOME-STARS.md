...
- [H4ckF0rFun/elf_to_shellcode](https://github.com/H4ckF0rFun/elf_to_shellcode) - Convert any elf or command to shellcode
...
- [ProbiusOfficial/ssrf-labs](https://github.com/ProbiusOfficial/ssrf-labs) - 一个ssrf的综合靶场，基于国光师傅的sqlsec/ssrf-vuls
...
- [liyupi/mianshiya](https://github.com/liyupi/mianshiya) - 持续维护的面试刷题网站，帮你拿到满意 offer！⭐️ 2025年最新Java面试题、前端面试题、C++面试题、Go面试题、Python面试题、测试面试题、运维面试题、后端面试题、操作系统面试题、计算机网络面试题、Redis面试题、MySQL数据库面试题、算法面试题、Spring面试题、JVM面试题、Java并发面试题、Linux面试题等几千道高频程序员求职必备八股文。💎 React 前端 + N
