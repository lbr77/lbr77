...
- [mildsunrise/cursed_gpu_linux](https://github.com/mildsunrise/cursed_gpu_linux) - ⚙️ shitty desktop RISC-V linux emulator
- [lbr77/OS](https://github.com/lbr77/OS) - rCore项目 C实现
...
- [CrackTC/Robin.cs](https://github.com/CrackTC/Robin.cs) - QQ bot framework & some useless extensions
- [VedalAI/neuro-amongus](https://github.com/VedalAI/neuro-amongus) - Among Us Plugin for Neuro-sama
...
- [H4ckF0rFun/MFC-HexEditCtrl](https://github.com/H4ckF0rFun/MFC-HexEditCtrl) - A simple hexadecimal editor control
- [microsoft/calculator](https://github.com/microsoft/calculator) - Windows Calculator: A simple yet powerful calculator that ships with Windows
- [lynx-family/lynx](https://github.com/lynx-family/lynx) - Empower the Web community and invite more to build across platforms.
- [ANTiSOC1AL/SEU_553](https://github.com/ANTiSOC1AL/SEU_553) - 东南大学复试553历年机试代码
- [southernEast/SEU_553](https://github.com/southernEast/SEU_553) - 东南大学网络空间安全学院复试
- [deepseek-ai/FlashMLA](https://github.com/deepseek-ai/FlashMLA) - FlashMLA: Efficient MLA decoding kernels
- [Lakr233/html2md](https://github.com/Lakr233/html2md) - Transform your HTML into clean, easy-to-read markdown with html2md.
...
- [For-ACGN/go-keystone](https://github.com/For-ACGN/go-keystone) - WASM based bindings for the Keystone assembler
...
- [SunBK201/UA3F](https://github.com/SunBK201/UA3F) - Next generation of HTTP User-Agent modification methodology.
...
- [sonumb-z/AutoDecompileApplet](https://github.com/sonumb-z/AutoDecompileApplet) - 一个自动化微信小程序反编译工具
...
- [QiuChenly/VSCodePluginManager](https://github.com/QiuChenly/VSCodePluginManager) - 去你大爷的vscode扩展管理器
...
- [Minestom/Minestom](https://github.com/Minestom/Minestom) - 1.21.4 Lightweight Minecraft server
...
- [YttriumC/Redmi-K40-First-Screen-Logo-Changer](https://github.com/YttriumC/Redmi-K40-First-Screen-Logo-Changer) - 修改红米K40手机的开机第一屏Logo界面(logo分区)
...
- [mix-archive/web-security-slides](https://github.com/mix-archive/web-security-slides) - 
...
- [JorianWoltjer/deobfuscate-preemptive](https://github.com/JorianWoltjer/deobfuscate-preemptive) - Automatically deobfuscate JavaScript code 'Protected' with PreEmptive's JSDefender Demo
...
- [GeorgeXie2333/LLM-Stream-Optimizer](https://github.com/GeorgeXie2333/LLM-Stream-Optimizer) - ⚡基于 Cloudflare Workers 优化LLM流式输出，支持多种格式API，转换大型响应块，带Web管理页，原生Fetch请求（ShadowFetch），支持多KEY负载均衡
...
- [veithly/JupFree](https://github.com/veithly/JupFree) - Adds a Jup Trade button to gmgn, dexx, debot websites for quick Jupiter trading.
- [liseami/DeepRant](https://github.com/liseami/DeepRant) - -游戏文字交流AI嘴强王者工具
- [ConradIrwin/gpg-decoder](https://github.com/ConradIrwin/gpg-decoder) - A port of the awesome ASN.1 Javascript Decoder for GPG messages
- [fejich/docker-embyhack](https://github.com/fejich/docker-embyhack) - 使用 Docker Compose 编排整合 emby 伪站授权
...
- [USTC-Hackergame/hackergame2023-writeups](https://github.com/USTC-Hackergame/hackergame2023-writeups) - Hackergame 2023 的官方与非官方题解
...
- [Xecades/Homepage](https://github.com/Xecades/Homepage) - Xecades' Homepage, part of the Alpha project
...
- [OxygenFramework/Oxygen.jl](https://github.com/OxygenFramework/Oxygen.jl) - 💨 A breath of fresh air for programming web apps in Julia
...
- [jackliaoall/data_tangyudi](https://github.com/jackliaoall/data_tangyudi) - 唐宇迪 資料收集
...
- [shansongliu/MuMu-LLaMA](https://github.com/shansongliu/MuMu-LLaMA) - This is the official repository for M2UGen
...
- [woctezuma/stable-diffusion-colab](https://github.com/woctezuma/stable-diffusion-colab) - Colab notebook for Stable Diffusion Hyper-SDXL.
...
- [Ashampoo/kim](https://github.com/Ashampoo/kim) - Image metadata manipulation library for Kotlin Multiplatform
...
- [YZune/CourseAdapter](https://github.com/YZune/CourseAdapter) - 
...
- [Sennagi-fox/MG-Aide](https://github.com/Sennagi-fox/MG-Aide) - MG Aide
...
- [lazyparser/weloveinterns](https://github.com/lazyparser/weloveinterns) - We ❤️ Interns!
- [AsahiLinux/asahi-audio](https://github.com/AsahiLinux/asahi-audio) - Userspace audio for Asahi Linux
- [ghostplant/ubuntu-pe](https://github.com/ghostplant/ubuntu-pe) - Ubuntu PE Desktop for ARM64/AMD64: A Fast, Portable and Power-Saving ISO Edition for Ubuntu/Debian LTS
...
- [ITxiao666/SUSFS-GKI-Kernel](https://github.com/ITxiao666/SUSFS-GKI-Kernel) - 具有KernelSU 和SUSFS的GKI内核
...
- [Nop3z/IOTsec-all-in-one](https://github.com/Nop3z/IOTsec-all-in-one) - 收集IOT安全相关资料
- [moonbit-community/Community-Tasks](https://github.com/moonbit-community/Community-Tasks) - MoonBit 社区任务列表
...
- [LindleyLin/JLUCloud](https://github.com/LindleyLin/JLUCloud) - 一个 安卓 苹果 平台的 吉林大学教务系统 课表 成绩 考试时间 显示前端
- [charonlight/xxl-jobExploitGUI](https://github.com/charonlight/xxl-jobExploitGUI) - xxl-job最新漏洞利用工具
...
- [yutianqaq/CSx3Ldr](https://github.com/yutianqaq/CSx3Ldr) - Cobalt Strike插件
...
- [CTF-Archives/2024-wdb-baihu](https://github.com/CTF-Archives/2024-wdb-baihu) - 第四届 “网鼎杯” 网络安全大赛 白虎组 初赛
- [CTF-Archives/2024-wdb-qinglong](https://github.com/CTF-Archives/2024-wdb-qinglong) - 第四届 “网鼎杯” 网络安全大赛 青龙组 初赛
...
- [CTF-Archives/2024-CISCN-Finals-AWDP](https://github.com/CTF-Archives/2024-CISCN-Finals-AWDP) - 第十七届全国大学生信息安全竞赛创新实践能力赛决赛 - AWDP
...
- [Zhu-mjl1/re-exam-problem-set](https://github.com/Zhu-mjl1/re-exam-problem-set) - 
...
- [A-SunsetMkt-Forks/awesome-tunneling](https://github.com/A-SunsetMkt-Forks/awesome-tunneling) - List of ngrok alternatives and other ngrok-like tunneling software and services. Focus on self-hosting.
- [ZianTT/BHYG](https://github.com/ZianTT/BHYG) - B站 会员购 抢票 脚本
...
- [ParaN3xus/phira_ipa](https://github.com/ParaN3xus/phira_ipa) - ipa file of phira
...
- [zhengjim/Chinese-Security-RSS](https://github.com/zhengjim/Chinese-Security-RSS) - 网络安全、信息安全资讯的RSS订阅，网络安全、信息安全博客的RSS订阅，网络安全、信息安全公众号的RSS订阅
...
- [YoulianBoshi/vpn](https://github.com/YoulianBoshi/vpn) - 
- [mooseIre/update_miui_ota](https://github.com/mooseIre/update_miui_ota) - 
- [bamf2077/quarklist](https://github.com/bamf2077/quarklist) - 一款针对国内用户的广告过滤列表，作为 EasyList China 的补充，适用于 Adblock Plus、AdBlock、uBlock Origin 等浏览器扩展。 An advertising filter served as a supplement to EasyList China for users in mainland China, applicable to Adblock P
...
- [Re13orn/xss-lab](https://github.com/Re13orn/xss-lab) - 20 level xss lab by network!!!
- [m3m0r7/php-os](https://github.com/m3m0r7/php-os) - An operating system written in PHP
...
- [CTF-Archives/2024-VNCTF-OnlyLocalSql](https://github.com/CTF-Archives/2024-VNCTF-OnlyLocalSql) - VNCTF2024 - Misc - OnlyLocalSql - Source Code
...
- [Player626/CommentPush](https://github.com/Player626/CommentPush) - 基于Typecho评论推送服务
...
- [jiayuqi7813/chal_with_snowy](https://github.com/jiayuqi7813/chal_with_snowy) - 与熊论道死了？没关系，我有与雪论题
- [schinger/AlphaZero](https://github.com/schinger/AlphaZero) - Simplest AlphaZero Implementation
- [ThumpBo/CVE-2025-30208-EXP](https://github.com/ThumpBo/CVE-2025-30208-EXP) - CVE-2025-30208-EXP
...
- [salikx/image2pdf](https://github.com/salikx/image2pdf) - 将JMComic-Crawler下载的图片合并到pdf中
...
- [0x6rss/CVE-2025-24071_PoC](https://github.com/0x6rss/CVE-2025-24071_PoC) - CVE-2025-24071: NTLM Hash Leak via RAR/ZIP Extraction and .library-ms File
...
- [lancopku/agent-backdoor-attacks](https://github.com/lancopku/agent-backdoor-attacks) - Code&Data for the paper "Watch Out for Your Agents! Investigating Backdoor Threats to LLM-Based Agents" [NeurIPS 2024]
- [ssssi/freqtrade_strs](https://github.com/ssssi/freqtrade_strs) - Trading Strategies for Freqtrade
...
- [ucgJhe/Qdb](https://github.com/ucgJhe/Qdb) - A multi-architecture and cross-platform debugger baked by Qiling Framework
...
- [bysansheng/AniSort](https://github.com/bysansheng/AniSort) - 番剧文件整理工具
...
- [okatu-loli/Electricity-Tracker](https://github.com/okatu-loli/Electricity-Tracker) - 用于自动化电费监控
- [ARC-MX/sgcc_electricity_new](https://github.com/ARC-MX/sgcc_electricity_new) - HomeAssistant 国家电网电费查询
- [nowar-fonts/Nowar-Rounded](https://github.com/nowar-fonts/Nowar-Rounded) - Nowar Rounded / 有爱圆体 / 有愛圓體 / 有愛丸ゴシック / 有愛 굴림, font packs for World of Warcraft and WoW Classic that support all client languages.
- [jiayuqi7813/vnctf2025-aimind](https://github.com/jiayuqi7813/vnctf2025-aimind) - Source code for vnctf2025 aimind challenge
...
- [windshadow233/Mahjong-AI](https://github.com/windshadow233/Mahjong-AI) - 基于Suphx的立直麻将AI
...
- [KwaiVGI/GameFactory](https://github.com/KwaiVGI/GameFactory) - [ARXIV'25] GameFactory: Creating New Games with Generative Interactive Videos
- [liang5211314/federated_backdoor_attack](https://github.com/liang5211314/federated_backdoor_attack) - 联邦学习，后门攻击，简单实现
...
- [SafeBreach-Labs/CVE-2024-49113](https://github.com/SafeBreach-Labs/CVE-2024-49113) - LdapNightmare is a PoC tool that tests a vulnerable Windows Server against CVE-2024-49113
...
- [artooze/crypto-arbitrager](https://github.com/artooze/crypto-arbitrager) - crypto asset arbitrage opportunity watcher, market maker, hedge and arbitrage
...
- [DogsTailFarmer/martin-binance](https://github.com/DogsTailFarmer/martin-binance) - Free trading system for crypto exchanges SPOT market. Adaptive customizable reverse grid strategy based on martingale.
...
- [JorianWoltjer/nodejs-file-write-rce](https://github.com/JorianWoltjer/nodejs-file-write-rce) - NodeJS File Write to RCE on a read-only filesystem using a ROP chain in libuv
...
- [sherdencooper/PromptFuzz](https://github.com/sherdencooper/PromptFuzz) - 
- [Dliv3/redis-rogue-server](https://github.com/Dliv3/redis-rogue-server) - Redis 4.x/5.x RCE
- [Unispac/Visual-Adversarial-Examples-Jailbreak-Large-Language-Models](https://github.com/Unispac/Visual-Adversarial-Examples-Jailbreak-Large-Language-Models) - Repository for the Paper (AAAI 2024, Oral) --- Visual Adversarial Examples Jailbreak Large Language Models
...
- [B1ue1nWh1te/Poseidon](https://github.com/B1ue1nWh1te/Poseidon) - 海神波塞冬，本工具库对常用的链上交互操作进行了模块化抽象与简洁式封装，让开发者能够轻松快速地与主流区块链网络进行交互。目前支持任意 EVM 链。
- [junaire/run.cu](https://github.com/junaire/run.cu) - Compile & run a single CUDA file on the cloud GPUs
...
- [FHPythonUtils/TStickers](https://github.com/FHPythonUtils/TStickers) - Download sticker packs from Telegram
...
- [leslievan/semi-utils](https://github.com/leslievan/semi-utils) - 一个批量添加相机机型和拍摄参数的工具，后续「可能」添加其他功能。
...
- [sekai-soft/code-launcher](https://github.com/sekai-soft/code-launcher) - Jetbrains Toolbox for VSCode!
- [synacktiv/php_filter_chains_oracle_exploit](https://github.com/synacktiv/php_filter_chains_oracle_exploit) - A CLI to exploit parameters vulnerable to PHP filter chain error based oracle.
...
- [PallasBot/Pallas-Bot](https://github.com/PallasBot/Pallas-Bot) - 《明日方舟》帕拉斯 Bot
...
- [winterant/oi](https://github.com/winterant/oi) - CSP-J/S/X, NOIP, NOI, IOI, 信息学奥林匹克竞赛历年真题收录 | QQ交流群529507453
...
- [LagrangeDev/mania](https://github.com/LagrangeDev/mania) - An Implementation of NTQQ Protocol, with Pure Rust🦀, Derived from Lagrange.Core
...
- [blockscout/blockscout-rs](https://github.com/blockscout/blockscout-rs) - Microservices for blockscout indexer
...
- [yhan219/navicat_reset_mac](https://github.com/yhan219/navicat_reset_mac) - navicat16/17 mac版无限重置试用期脚本
...
- [simonjwright/building-gcc-macos-cross](https://github.com/simonjwright/building-gcc-macos-cross) - Scripts for building GCC on macOS as a cross-compiler (arm-eabi, riscv64-elf)
- [ProbiusOfficial/ssrf-labs](https://github.com/ProbiusOfficial/ssrf-labs) - 一个ssrf的综合靶场，包含RCE，SQL注入，Tomcat，Redis，MySQL提权等ssrf攻击场景
...
- [MrCee/Synology-Homebrew](https://github.com/MrCee/Synology-Homebrew) - A streamlined installation of Homebrew on Synology NAS, featuring libraries and packages to help you install what you need without conflicts. Perfect for enhancing your Synology NAS with additional so
- [AdepojuJeremy/Cuda-120-Days-Challenge](https://github.com/AdepojuJeremy/Cuda-120-Days-Challenge) - A 120-day CUDA learning plan covering daily concepts, exercises, pitfalls, and references (including “Programming Massively Parallel Processors”). Features six capstone projects to solidify GPU parall
- [IceWhaleTech/ZimaOS](https://github.com/IceWhaleTech/ZimaOS) - 
- [DASCTF-Offical/Docker-Template-For-PWN-Base](https://github.com/DASCTF-Offical/Docker-Template-For-PWN-Base) - PWN类 Docker环境 基础镜像
...
- [lieanu/LibcSearcher](https://github.com/lieanu/LibcSearcher) - glibc offset search for ctf.
...
- [ithacaxyz/exp-0001](https://github.com/ithacaxyz/exp-0001) - Account Delegation with EIP-7702
- [eth-sri/securify2](https://github.com/eth-sri/securify2) - Securify v2.0
- [theredguild/damn-vulnerable-defi](https://github.com/theredguild/damn-vulnerable-defi) - The smart contract security training ground for developers, security researchers and educators.
- [zysgmzb/My-Damn-Vulnerable-DeFi-V4-solutions](https://github.com/zysgmzb/My-Damn-Vulnerable-DeFi-V4-solutions) - my solutions for Damn Vulnerable DeFi v4
...
- [Bobface/onlypwner-challenges](https://github.com/Bobface/onlypwner-challenges) - Challenges for the ONLYPWNER CTF Platform
- [minaminao/ctf-blockchain](https://github.com/minaminao/ctf-blockchain) - A summary of 200+ CTF blockchain challenges
- [sherlock-audit/2023-02-kairos](https://github.com/sherlock-audit/2023-02-kairos) - 
...
- [noionion/noionion.github.io](https://github.com/noionion/noionion.github.io) - blog
...
- [Lakr233/ScrubberKit](https://github.com/Lakr233/ScrubberKit) - 
...
- [Lightning-Lion/CropFrameOpenSource](https://github.com/Lightning-Lion/CropFrameOpenSource) - MR手势取景框拍照Demo
- [Lakr233/FlowDown-App](https://github.com/Lakr233/FlowDown-App) - https://flowdown.ai/
- [Lakr233/ConfigurableKit](https://github.com/Lakr233/ConfigurableKit) - Set up settings pages like a charm with UIKit.
...
- [zengsanxiang/sms-interception](https://github.com/zengsanxiang/sms-interception) - 拥有自己的短信拦截器
...
- [hyoban/sakuin](https://github.com/hyoban/sakuin) - SDK for XLog
...
- [jiayuqi7813/my-dapp-test-solana](https://github.com/jiayuqi7813/my-dapp-test-solana) - Dapp for beginners by nextjs
...
- [binance/binance-connector-typescript](https://github.com/binance/binance-connector-typescript) - Simple Typescript connector to Binance API
- [anyproto/anytype-ts](https://github.com/anyproto/anytype-ts) - Official Anytype client for MacOS, Linux, and Windows
- [ngfelixl/nodeplotlib](https://github.com/ngfelixl/nodeplotlib) - NodeJS plotting library for JavaScript and TypeScript. On top of plotly.js. Inspired by matplotlib.
...
- [PrinOrange/nextjs-lexical-blog](https://github.com/PrinOrange/nextjs-lexical-blog) - This is a sleek and efficient web blog project, built with Next.js + MDX + TailwindCSS. You can write your blog posts in Markdown and easily deploy them on Vercel. My depoly: https://dreams.plus
...
- [Mc-Zen/quill](https://github.com/Mc-Zen/quill) - Effortlessly create quantum circuit diagrams in Typst.
...
- [Xecades/Note](https://github.com/Xecades/Note) - Xecades' Note, part of the Alpha project
...
- [minaminao/lustrous](https://github.com/minaminao/lustrous) - Vyper Internals Challenge in HITCON CTF 2024 Quals
